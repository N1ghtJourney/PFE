...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        cmdLogOut.setBackground(Color.decode("#F28705"));
        add(header);
        add(panelMenu);
        add(bottom);
    }
    ...
    private void createButtonMenu() {
        ...
        cmdMenu.setIcon(new ImageIcon(getClass().getResource("/images/menu.png")));
        cmdMenu.setBorder(new EmptyBorder(5, 12, 5, 12));
    }

    private void createButtonLogout() {
        cmdLogOut = new ButtonCustom();
        cmdLogOut.setIcon(new ImageIcon(getClass().getResource("/images/exit.png")));
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, Color.decode("#4A6572"), 0, getHeight(), Color.decode("#344955"));
        g2.setPaint(gra);
