...
public class TextFieldSearchOption extends JTextField {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setColor(new Color(52, 73, 85));
        g2.drawRect(1, 1, getWidth() - 3, getHeight() - 3);
        if (isFocusOwner()) {
            g2.setColor(new Color(84, 111, 134));
    ...
    public void paint(Graphics grphcs) {
        ...
        area.add(new Area(p));
        g2.setPaint(new GradientPaint(new Point2D.Double(x, 0), new Color(52, 73, 85), new Point2D.Double(getWidth(), 0), new Color (84, 111, 134)));
        g2.fill(area);
        shape = area;
